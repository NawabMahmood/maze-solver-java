...
public class Simulation {
    ...
    private static boolean searchForWayOut(Labyrinth maze, Location current) {
        ...
        // Check if this current location has been visited
        if (maze.getSquareType(current).isVisited()) {
            return false;
        }
        
        // Check if this current location is the way out
        ...
        // Loop through all the neighbors and recursively call the method 
